...
#### Save to SHP and KML Files
```{r Save KYCC grants to SHP and KML}
...
#### Save to SHP and KML Files
```{r Save TP grants to SHP and KML}
...
#### Save to SHP and KML Files
```{r Save LACC_Valley grants to SHP and KML}
...
#### Save to SHP and KML Files
```{r Save HLABT grants to SHP and KML}
...
#### Save to SHP and KML Files
```{r Save NET grants to SHP and KML}
...
#### Save to SHP and KML Files 
```{r Save all grants to SHP and KML}
...
# Write smaller version of LASAN_GGLA
...
st_write(lasan_tree_only_city, "grant_area_flattened/LASAN_TREEandSHADE-FULL/LASAN_TREEandSHADE-FULL.shp", append = FALSE)

st_write(lasan_tree_only_city, "grant_area_flattened/LASAN_TREEandSHADE-FULL.kml", append = FALSE)

# Write smaller version of LASAN_TREEandSHADE
st_write(lasan_tree, "grant_area_flattened/LASAN_TREEandSHADE-removed/LASAN_TREEandSHADE-removed.shp", append = FALSE)

st_write(lasan_tree, "grant_area_flattened/LASAN_TREEandSHADE-removed.kml", append = FALSE)
```


## Combine all NP partner grants and LASAN grants
```{r}
