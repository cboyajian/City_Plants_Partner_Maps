...
```{r Save all grants to SHP and KML}
# Save LASAN_GGLA to shp and kml
st_write(lasan_tree, "grant_area_flattened/LASAN_TREEandSHADE/LASAN_TREEandSHADE.shp", append = FALSE)

st_write(lasan_tree, "grant_area_flattened/LASAN_TREEandSHADE.kml", append = FALSE)


# Save full LASAN_TREE area to KML
