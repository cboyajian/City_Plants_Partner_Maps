...
## Creating LASAN Boyle Heights area
...
lasan_boyle_heights <- st_intersection(net_area, lasan_boyle_heights_rough) %>% 
  select("Name", "geometry") %>% 
  mutate(Name = "LASAN_Boyle-Heights")

# Remove LASAN Boyle Heights from NET area
net_area_smaller <- st_difference(net_area, kycc_calfire_jefferson_rough)
